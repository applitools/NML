...
/**
 * iOS AnalyticsX App — Applitools NML + Sauce Labs Real Device
 *
 * ENV VARS:
 ...
 */
public class AnalyticsXIOSSauceLabsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        eyes.setBatch(new BatchInfo("Java SauceLabs | NML | iOS AnalyticsX"));
