...
/**
 * iOS Accessibility App — Applitools NML (multi-device) + Perfecto Real Device
 *
 * ENV VARS:
 ...
 */
public class AccessibilityIOSPerfectoMultidevice_Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        eyes.setBatch(new BatchInfo("Java Perfecto | Static/Slicing Dynamic | NML | iOS Accessibility | Multi Device"));
