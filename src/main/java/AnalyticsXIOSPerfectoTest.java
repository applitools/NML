...
/**
 * iOS AnalyticsX App — Applitools NML + Perfecto Real Device
 *
 * ENV VARS:
 ...
 */
public class AnalyticsXIOSPerfectoTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        eyes.setBatch(new BatchInfo("Java Perfecto | Static/Slicing Dynamic | NML | iOS AnalyticsX"));
